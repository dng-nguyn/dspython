...
![Dự báo tập hợp cho 5 quốc gia nguồn hàng đầu (2026). Dải phạm vi mô hình hiển thị sự bất đồng giữa LR, RF, XGBoost và SARIMAX.](output/country_forecasts_plot.png)
...
Với dữ liệu thực tế có sẵn cho 5 tháng đầu năm 2026, chúng ta có thể đánh giá dự báo chỉ-SARIMAX so với thực tế (dự báo tập hợp sử dụng thành phần SARIMAX tương tự cho dự báo tổng hợp).
