...
- **Tập huấn luyện (Training set):** Tháng 1 năm 2012 -- Tháng 12 năm 2023 (144 tháng, liên tục). Bao gồm các tháng đóng cửa COVID đã được điền giá trị 0 (tháng 4 năm 2020--tháng 12 năm 2021) với `covid_closed = 1`, cung cấp cho mô hình một lịch hoàn chỉnh và tín hiệu điểm gãy cấu trúc.
...
SARIMAX (Seasonal AutoRegressive Integrated Moving Average with eXogenous variables) [7, 8] là một mô hình thống kê cổ điển phân tích một chuỗi thời gian thành các thành phần tự hồi quy (autoregressive), sai phân (differencing), trung bình trượt (moving-average) và mùa vụ, được bổ sung thêm các biến hồi quy exogenous:
...
**Các giả định:** Tính dừng sau khi lấy sai phân; các phần dư là nhiễu trắng. Giai đoạn đóng cửa COVID (tháng 4 năm 2020--tháng 12 năm 2021) được điền giá trị 0 với `covid_closed = 1`, duy trì tính liên tục của lịch để các đặc trưng trễ bắc cầu khoảng trống một cách chính xác.
...
| XGBoost | 313.159 | 369.109 | 19,88\% | 0,11 |
| SARIMAX$(1,1,1)(1,1,1)_{12}$ | 320.315 | 396.549 | 21,66\% | $-$0,03 |
| CIR\# | 489.200 | 573.449 | 28,54\% | $-$1,14 |
...
- SARIMAX với $s = 12$ và biến exogenous `covid_closed` (MAPE = 21,66\%, R$^2$ = $-$0,03) cải thiện so với SARIMA gốc không có biến exogenous.
...
- Ba mô hình (Linear Regression, Random Forest, XGBoost) đạt giá trị R$^2$ dương, trong khi SARIMAX, Chronos và CIR\# vẫn ở mức âm do điểm gãy cấu trúc sau COVID.
...
|-------|--------|----------------|----------------|
| Tháng 1/2026 | 1.558.157 | 743.110 | 2.373.205 |
| Tháng 2/2026 | 1.548.631 | 524.976 | 2.572.285 |
| Tháng 3/2026 | 1.409.524 | 158.421 | 2.660.628 |
| Tháng 4/2026 | 1.461.912 | 43.534 | 2.880.290 |
| Tháng 5/2026 | 1.402.826 | 0 | 2.982.026 |
| Tháng 6/2026 | 1.363.119 | 0 | 3.082.894 |
| Tháng 7/2026 | 1.423.628 | 0 | 3.275.842 |
| Tháng 8/2026 | 1.501.787 | 0 | 3.476.374 |
| Tháng 9/2026 | 1.429.359 | 0 | 3.519.748 |
| Tháng 10/2026 | 1.453.412 | 0 | 3.653.234 |
| Tháng 11/2026 | 1.505.489 | 0 | 3.809.689 |
| Tháng 12/2026 | 1.605.797 | 0 | 4.009.780 |

Tất cả các cận dưới khoảng tin cậy đều không âm, được cắt về 0 khi sự không chắc chắn của mô hình tạo ra các giá trị âm không thể có.

Các khoảng tin cậy được cắt về 0 ở cận dưới, vì lượng khách du lịch không thể âm. SARIMAX, được huấn luyện trên dữ liệu bao gồm giai đoạn đóng cửa COVID với biến exogenous `covid_closed`, tạo ra dự báo có tính đến điểm gãy cấu trúc. Tuy nhiên, mô hình vẫn có xu hướng hồi quy về giá trị trung bình và tạo ra các dải không chắc chắn rộng, phản ánh thách thức cơ bản của việc ngoại suy quỹ đạo tăng trưởng từ một mô hình được thiết kế cho các quy trình dừng.

## Dự báo theo quốc gia nguồn (2026)

Các mô hình SARIMAX cũng được điều chỉnh cho 5 quốc gia nguồn hàng đầu, mỗi quốc gia với đặc tả $(1,1,1)(1,1,1)_{12}$ và biến exogenous `covid_closed`.

![Dự báo 12 tháng của SARIMAX cho 5 quốc gia nguồn hàng đầu (2026).](output/country_forecasts_plot.png)

| Tháng | Hàn Quốc | Trung Quốc | Campuchia | Nhật Bản | Nga |
|-------|----------|------------|-----------|----------|-----|
| Tháng 1/2026 | 406.033 | 225.944 | 79.694 | 58.328 | 30.915 |
| Tháng 2/2026 | 425.290 | 243.241 | 71.998 | 73.671 | 0 |
| Tháng 3/2026 | 406.926 | 237.041 | 66.775 | 63.948 | 1.635 |
| Tháng 4/2026 | 436.806 | 266.077 | 69.734 | 63.759 | 33.858 |
| Tháng 5/2026 | 432.141 | 256.206 | 66.298 | 62.497 | 35.968 |
| Tháng 6/2026 | 440.612 | 235.861 | 64.801 | 62.218 | 27.508 |
| Tháng 7/2026 | 441.553 | 240.007 | 62.298 | 64.854 | 27.994 |
| Tháng 8/2026 | 483.539 | 240.881 | 63.978 | 75.912 | 28.229 |
| Tháng 9/2026 | 451.197 | 228.056 | 64.054 | 75.121 | 28.193 |
| Tháng 10/2026 | 455.982 | 238.553 | 68.781 | 70.844 | 28.071 |
| Tháng 11/2026 | 458.589 | 252.875 | 71.295 | 73.937 | 30.572 |
| Tháng 12/2026 | 479.518 | 253.037 | 77.163 | 75.748 | 26.281 |
| **Tổng** | **5.318.186** | **2.917.779** | **826.869** | **820.837** | **299.222** |

5 quốc gia hàng đầu chiếm 57,6\% tổng dự báo tích lũy năm 2026 (10,2 trên 17,7 triệu). Hàn Quốc được dự báo vẫn là thị trường nguồn lớn nhất, tiếp theo là Trung Quốc. Nga (Russia) cho thấy sự không chắc chắn dự báo cao nhất, với mô hình tạo ra cận dưới bị cắt về 0 cho tháng 2, phản ánh tính biến động mùa vụ trong một thị trường có khối lượng cơ bản thấp hơn.
...
5. **Điểm gãy cấu trúc sau COVID** vẫn là thách thức thống trị. Ba mô hình (XGBoost, Random Forest, Linear Regression) đạt giá trị R$^2$ dương, trong khi SARIMAX, Chronos và CIR\# vẫn ở mức âm vì phân phối của tập kiểm tra (phục hồi 2024--2025) khác biệt cơ bản so với phân phối của tập huấn luyện (2012--2023).

6. **CIR\# thất bại trên dữ liệu có xu hướng.** Mặc dù có dữ liệu hàng tháng như khuyến nghị của Orlando và Bufalo [13], giả định hồi quy về giá trị trung bình của mô hình bị vi phạm bởi quỹ đạo du lịch có xu hướng đi lên của Việt Nam. Đây là một điều kiện biên được tài liệu hóa cho mô hình [13, 14].
...
1. **Khoảng trống COVID (2020--2021):** Điền giá trị 0 cho giai đoạn đóng cửa COVID duy trì tính liên tục của lịch; biến exogenous `covid_closed` báo hiệu điểm gãy cấu trúc cho SARIMAX. Tuy nhiên, các tháng điền 0 vẫn đại diện cho một sự khác biệt so với quy trình tạo dữ liệu thực sự.
